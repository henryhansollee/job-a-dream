    ...
    <v-stepper v-model="e1">
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="2">
          ...
          >
            ...
            >
              ...
              <button class="btn btn-secondary" v-else @click="stopRecording">
                녹음종료
              </button>
            </dictaphone>
        ...
        <v-stepper-content step="3">
          ...
          <div class="w-100 d-flex flex-column">
            <v-btn
              v-if="audioData.title && audioData.update_tag"
              class="basic-btn align-self-center m-4 w-25 text-white"
              color="cyan"
              @click="createAudioFormData()"
              >완료</v-btn
            >
            <b-form-input
              v-else
              class="align-self-center m-4 w-25"
              color="primary"
              depressed
              disabled
              >완료</b-form-input
